...
PRODUCT_DATASET = f"{GCP_PROJECT_ID}.product"
...
GOOGLE_SEARCH_CONSOLE_SITE_URL = os.environ.get("GOOGLE_SEARCH_CONSOLE_SITE_URL", "")
GOOGLE_SEARCH_CONSOLE_SITE_URL_SHOP = os.environ.get("GOOGLE_SEARCH_CONSOLE_SITE_URL_SHOP", "")
...
GOOGLE_SEARCH_CONSOLE_REFRESH_TOKEN = os.environ.get("GOOGLE_SEARCH_CONSOLE_REFRESH_TOKEN", "")
GOOGLE_SEARCH_CONSOLE_REFRESH_TOKEN_SHOP = os.environ.get("GOOGLE_SEARCH_CONSOLE_REFRESH_TOKEN_SHOP", "")
