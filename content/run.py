...
Usage:
    ...
    uv run python -m content.run --generate --count 10  # Generate 10 new variations
...
def main():
    ...
    if args.all or args.generate:
        ...
        log.info("--- Running content generation ---")
        generate(count=args.count, product=args.product, to_stdout=args.to_stdout)
